...
public class ConnectivityInfo {
	...
	*/
	public ConnectivityInfo(Context mContext) {
		try {
			...
			operator1 = Utility.getPreferences(mContext, LocalConstants.SIM_OPERATOR_1);
			operator2 = Utility.getPreferences(mContext, LocalConstants.SIM_OPERATOR_2);;
		} catch (Exception e) {
			//e.printStackTrace();
		}
	...
	*/
	...
	public HashMap<String, String> getNetworkDetails() {
		...
		try {
			DualSimManagerNew dualSimDetails = new DualSimManagerNew(mContext);
